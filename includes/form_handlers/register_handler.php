...
if(isset($_POST['register_button'])){
	...
	$_SESSION['reg_name'] = $name; //Stores first name into session variable
	...
	if(empty($error_array)) {
		...
		$query = mysqli_query($con, "INSERT INTO users VALUES ('', '$fname', '$username', '$em', '$password', '$date', '$profile_pic' ,'$gender')");
